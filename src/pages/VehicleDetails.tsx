...
const VehicleDetails = () => {
  ...
  const translations = {
    ...
    vehicleNotFoundDesc: "Le véhicule que vous recherchez n'existe pas ou a été supprimé.",
    ...
    orderSuccessful: "Commande effectuée avec succès",
    orderSent: "Commande envoyée",
    orderReceived: "Nous avons bien reçu votre commande",
    orderError: "Erreur lors de la commande",
    error: "Erreur",
    orderErrorDesc: "Une erreur est survenue lors de la commande. Veuillez réessayer.",
