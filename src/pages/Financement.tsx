...
const Financement = () => {
  ...
  // Translation dictionary for the Financing page
  const translations = {
    financingTitle: {
              ...
              <Card className="border-t-4 border-t-brand-blue shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-6">
                    ...
                    <h3 className="text-xl font-bold mb-2">{translate('traditionalCredit', translations.traditionalCredit)}</h3>
                    <p className="text-gray-600">
                      {translate('traditionalCreditDesc', translations.traditionalCreditDesc)}
                    </p>
                  </div>
                  ...
                  <div className="mb-6">
                    <div className="bg-gray-100 p-4 rounded-lg">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="font-semibold">{translate('months12to84', translations.months12to84)}</span>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-gray-600">{translate('downPayment', translations.downPayment)}</span>
                        <span className="font-semibold">{translate('from10percent', translations.from10percent)}</span>
                      </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <span className="text-gray-600">{translate('fixedPayments', translations.fixedPayments)}</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-600">{translate('earlyRepayment', translations.earlyRepayment)}</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-600">{translate('youOwnVehicle', translations.youOwnVehicle)}</span>
                    </div>
                  </div>
              ...
              <Card className="border-t-4 border-t-brand-orange shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="pt-6">
                  <div className="absolute top-0 right-0 bg-brand-orange text-white px-4 py-1 text-sm font-semibold rounded-bl-lg">
                    {translate('popular', translations.popular)}
                  </div>
